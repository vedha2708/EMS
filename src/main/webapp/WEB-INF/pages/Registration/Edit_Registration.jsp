...
<form:form name="EditRegistrationFormid" id="EditRegistrationFormid" action="EditRegistrationAction"
	method='POST' commandName="EditRegistrationCMD">
	<div class="container">
		<div class="card">
			<div class="card-header">
				<h4 align="center">Update User Details</h4>
			</div>
			<!-- end of card-header -->
			<div class="card-body card-block">
				<div class="row mb-3">
					...
					<div class="col-md-4">
						<input type="text" id="name" name="name" autocomplete="off" class="form-control" readonly = "readonly">
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-md-4">
					<input type="date" id="dob" name="dob" autocomplete="off" class="form-control" readonly = "readonly">
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-md-4">
					<input type="date" id="joining_date" name="joining_date" autocomplete="off" class="form-control" readonly = "readonly">
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-md-4">
					<input type="text" id="blood_group" name="blood_group" autocomplete="off" class="form-control"  readonly = "readonly">
					</div>
				</div>
